 ...
 * Return Type  : void
 */
void main_predict_shufflenet_onnx(void)
{
  static float fv[150528];
  float out[1000];
  /* Initialize function 'predict_shufflenet_onnx' input arguments. */
  /* Initialize function input argument 'in'. */
  /* Call the entry-point 'predict_shufflenet_onnx'. */
  argInit_224x224x3_real32_T(fv);
  predict_shufflenet_onnx(fv, out);
}
