 ...
 * only. Not for sale.
 * File: _coder_predict_shufflenet_onnx_api.c
 *
...
/* Include Files */
#include "_coder_predict_shufflenet_onnx_api.h"
#include "_coder_predict_shufflenet_onnx_mex.h"
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "predict_shufflenet_onnx",                            /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
                                 ...
                                 const mxArray **plhs)
{
  ...
  predict_shufflenet_onnx(*in, *out);
...
void predict_shufflenet_onnx_atexit(void)
{
  ...
  predict_shufflenet_onnx_xil_terminate();
  predict_shufflenet_onnx_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_predict_shufflenet_onnx_api.c
 *
 * [EOF]
 */
