...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = shufflenet_v2.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = shufflenet_v2.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = shufflenet_v2.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = shufflenet_v2.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = shufflenet_v2.coder.ops.extractIfDlarray(numDimsIdx_);
