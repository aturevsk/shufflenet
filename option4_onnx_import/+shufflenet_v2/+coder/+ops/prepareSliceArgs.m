...
Starts = shufflenet_v2.coder.ops.extractIfDlarray(Starts_);
Ends = shufflenet_v2.coder.ops.extractIfDlarray(Ends_);
Axes_ = shufflenet_v2.coder.ops.extractIfDlarray(Axes__);
Steps_ = shufflenet_v2.coder.ops.extractIfDlarray(Steps__);
