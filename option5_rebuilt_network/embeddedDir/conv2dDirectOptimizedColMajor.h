 ...
 * only. Not for sale.
 * File: conv2dDirectOptimizedColMajor.h
 *
 * MATLAB Coder version            : 26.1
 * C/C++ source code generated on  : 21-Mar-2026 02:18:26
 */

#ifndef CONV2DDIRECTOPTIMIZEDCOLMAJOR_H
#define CONV2DDIRECTOPTIMIZEDCOLMAJOR_H
...
void c_conv2dDirectOptimizedColMajor(const float X[18816], float Z[45472]);
...
void d_conv2dDirectOptimizedColMajor(const float X[75264], float Z[181888]);
...
void e_conv2dDirectOptimizedColMajor(const float X[181888], float Z[45472]);
...
void f_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);
...
void g_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);

void gb_conv2dDirectOptimizedColMajo(const float X[22736], float Z[22736]);

void h_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);

void hb_conv2dDirectOptimizedColMajo(const float X[22736], float Z[22736]);

void i_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);

void ib_conv2dDirectOptimizedColMajo(const float X[22736], float Z[22736]);

void j_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);

void jb_conv2dDirectOptimizedColMajo(const float X[22736], float Z[22736]);

void k_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);

void kb_conv2dDirectOptimizedColMajo(const float X[22736], float Z[22736]);

void l_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);

void lb_conv2dDirectOptimizedColMajo(const float X[22736], float Z[22736]);

void m_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);

void mb_conv2dDirectOptimizedColMajo(const float X[22736], float Z[22736]);

void n_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);

void nb_conv2dDirectOptimizedColMajo(const float X[22736], float Z[22736]);

void o_conv2dDirectOptimizedColMajor(const float X[45472], float Z[45472]);
...
#endif
/*
 * File trailer for conv2dDirectOptimizedColMajor.h
 *
 * [EOF]
 */
